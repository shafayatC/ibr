        ...
        <div className="container mx-auto">
            ...
            <div className="flex flex-col justify-center w-full  gap-5">
                <div className=" flex justify-center">
                    <button onClick={signInWithFacebook} className="py-1 text-xs px-2 gap-5 center-line w-60  border border-gray-500  font-medium rounded-lg  hover:bg-green-400 hover:shadow-lg "><i class="fa-brands text-xl  fa-facebook"></i>
                        Sign in with Facebook
                    </button>
                </div>
                <div className="flex justify-center">
                    <button onClick={signInWithGoogle} className="py-1 text-xs px-2 gap-5 w-60 center-line border border-gray-500  font-medium rounded-lg  hover:bg-green-400 hover:shadow-lg "><i class="fa-brands  text-xl fa-google"></i>
                        Sign in with Google
                    </button>
                </div>
                <div className="flex justify-center">
