    ...
    const resetPassFunc = async () => {
      ...
      if (getMail.match(validRegex)) {
        ...
        try {
          ...
          const rawResponse = await fetch('http://103.197.204.22:8007/api/2023-02/reset-password-form', {
            method: 'POST',
            headers: {
